...
class TestCar(unittest.TestCase):
    ...
    def test_01_add_car(self):
        """add_car adds correct cars to the car track and returns amount of cars (1p)"""
        test_track = car.CarTrack("Monaco", 15)
        test_car_1 = car.Car(10.0, "XXX-123")
        ...
        test_car_2 = car.Car(7.0, "AAA-456")
    ...
    def test_02_count_avg_consumption(self):
        """count_avg_consumption returns correct average consumption (1p)"""

        test_track = car.CarTrack("Monaco", 15)
        test_car_1 = car.Car(10.0, "XXX-123")
        test_car_2 = car.Car(8.0, "ABC-111")
        test_car_3 = car.Car(6.0, "GFJ-768")
    ...
    def test_03_get_winner(self):
        """get_winner returns the correct car (1p)"""

        test_track = car.CarTrack("Monaco", 15)
        test_car_1 = car.Car(4.5, "Ferrari")
        test_car_2 = car.Car(7.2, "BMW")
        test_car_3 = car.Car(10, "Volvo")
        test_car_4 = car.Car(6.7, "Toyota")
        ...
        self.assertEqual(
            ret.id, test_car_4.id,
            "get_winner should return Toyota, but your function returns {}".format(ret.id))


    def test_04_count_rounds(self):
        """count_rounds returns the correct amount of rounds driven(1p)"""

        test_track = car.CarTrack("Monaco", 15)
        test_car = car.Car(6.7, "Toyota")
