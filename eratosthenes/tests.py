...
class TestSieveOfEratosthenes(unittest.TestCase):
    ...
    def test_with_small_numbers(self):
        """sieve_of_eratosthenes returns 1 for numbers equal or below 2 (1p)"""
    ...
    def test_with_negative_numbers(self):
        """sieve_of_eratosthenes returns 0 for negative numbers (1p)"""
    ...
    def test_with_small_set(self):
        """sieve_of_eratosthenes returns 10 for numbers equal or below 30 (1p)"""
    ...
    def test_with_medium_set(self):
        """sieve_of_eratosthenes returns 19 for numbers equal or below 70 (1p)"""
