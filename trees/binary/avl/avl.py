...
class AVL(bst.BST):
    ...
    def right_rotation(self, node):
        ...
        parent, Q = node.left, node
        parent.right, Q.left = Q, parent.right
    ...
    def left_rotation(self, node):
        ...
        parent, Q = node.right, node
        parent.left, Q.right = Q, parent.left
    ...
    def double_left_right_rotation(self, node):
        ...
        original = node
        original.left = self.left_rotation(node.left)
        new_node = self.right_rotation(original)
    ...
    def double_right_left_rotation(self, node):
        ...
        original = node
        original.right = self.right_rotation(node.right)
        new_node = self.left_rotation(original)
