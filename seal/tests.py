...
class Test(unittest.TestCase):
    ...
    def test_01_constructor(self):
        """The constructor should initialise the correct values. (2p)"""
    ...
    def test_03_climb_on_rock(self):
        """climb_on_rock() should work correctly. (1p)"""
    ...
    def test_04_do_banana_pose(self):
        """The do_banana_pose() method should have three cases. (1p)"""
    ...
    def test_05_add_friend(self):
        """add_friend() should work correctly. (1p)"""
    ...
    def test_06_tell_friends(self):
        """tell_friends() should work correctly. (1p)"""
        s1 = Seal("Aristoteles")
        s2 = Seal("Alina")
        s3 = Seal("Walter")
    ...
    def test_07_request_banana_pose(self):
        """The result of requesting a banana pose should depend on friends (4p)."""
        s1 = Seal("Aristoteles")
        s2 = Seal("Alina")
        s3 = Seal("Walter")
        s4 = Seal("Ella")
