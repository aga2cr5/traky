...
class TestLinkedList(unittest.TestCase):
    ...
    def test_get_max(self):
        ...
        self.linked_list.add_first(20)
        self.linked_list.add_first(-1000)
        self.linked_list.add_first(80)
        self.linked_list.add_first(3)
        self.linked_list.add_first(6)
        self.linked_list.add_first(1)
        self.linked_list.add_first(56)
        ...
        80,
        max,
        "get_max should return 300 but instead it returns {}".format(max)
        )
